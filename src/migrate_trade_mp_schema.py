...
def preflight_additional_targets() -> list[Path]:
    relative_paths = [
        ...
        "src/config.py",
        "src/utils.py",
        "src/measure_x_11_stage2_code_trade_mp.py",
        "src/measure_x_12_stage2_compare_models.py",
        "src/measure_x_13_stage2_arbitrate_conflicts.py",
        "src/measure_x_14_finalize_provision_weights.py",
        "src/10_finalize_weights_single_stage2_model.py",
        "src/measure_x_15_compute_agreement_scores.py",
        "src/measure_x_16_compute_country_pair_year_scores.py",
        "src/measure_x_17_validate_outputs.py",
        ...
        "prompts/stage2_trade_mp.txt",
        "prompts/stage2_trade_mp_compact.txt",
        "prompts/stage2_trade_mp_compact_v4.txt",
